...
# USAGE:
# msg, index = AEDLocation(23.90190275700273, 121.55470193001676)
# print(msg)
# print(index)
...
def make_flex_carousel(x, y):
    ...
    message = FlexSendMessage(
        alt_text="附近AED資訊", contents=json.loads(finalstr.encode("utf-8")))

    return message


# make_flex_carousel(22.98270545629019, 120.18997991103201)
# print(eachLiff(""))
